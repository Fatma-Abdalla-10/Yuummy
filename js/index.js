...
let displayCategories = function (arr) {
    let cartoona = "";
...
let displayIngredients = function (arr) {
    let cartoona = "";
...
async function getMealDetails(event, mealID) {
